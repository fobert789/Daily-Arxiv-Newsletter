...
**Your personal research assistant — reads arXiv overnight, delivers the best papers to your inbox every morning.**

![Python](https://img.shields.io/badge/Python-3.11+-3776AB?style=flat&logo=python&logoColor=white)
![LLM](https://img.shields.io/badge/LLM-OpenRouter-6A0DAD?style=flat)
![DB](https://img.shields.io/badge/Database-SQLite-003B57?style=flat&logo=sqlite&logoColor=white)
![Scheduler](https://img.shields.io/badge/Scheduler-cron-4A90E2?style=flat)
...
|---|---|
| Language | Python 3.11+, no frameworks |
| Paper fetching | [arXiv Python package](https://github.com/lukasschwab/arxiv.py) |
| LLM calls | [OpenRouter](https://openrouter.ai) — `x-ai/grok-4.1-fast` / `deepseek/deepseek-v3.2` |
| Deduplication | SQLite |
| Email delivery | [exe.dev](https://exe.dev) HTTP gateway |
| Scheduling | cron |
...
| `emailer.py` | Plain-text email via gateway |
